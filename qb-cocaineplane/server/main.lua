...
-----/* Starting Location *\-----
---------------------------------
local hiddenstart = vector4(2122.3, 4784.77, 40.97, 115.07) -- Change this to whatever location you want. This is server side to prevent people from dumping the coords
...
AddEventHandler("qb-cocaineplane:processed", function(x,y,z)
	local src = source
	local Player = QBCore.Functions.GetPlayer(src)
	local pick = Config.BrickAmount
	  
	Player.Functions.RemoveItem('coke_brick', Config.BrickRemove, k)
